...
<div class="container-fluid">
    <div class="row"><div class="col-md-1.5" style = "width: 30px; height: 55px"></div><img class="col-md-1.5" src="${pageContext.request.contextPath}/img/pizzaPattern_cut-photo.ru.png" width="95%"></div>
